...
internal class Overlay : IDisposable
{
	...
	public (bool, long) WndProcMessage(WindowsMessage msg, ulong wParam, long lParam)
	{
		...
		if (!_windowFocused) { return (false, 0); }
